...
LIBMAP = {
    ...
    "Conn_01x41_Signal_SH": "Conn_01x41_Signal_SH",
    "Conn_01x51_Signal_SH": "Conn_01x51_Signal_SH",
    ...
    "TPS56637": "TPS56637",
    "LM706A0": "LM706A0",
    "TLV1864PW": "BMS_Thermal", "TPS70933DBV": "BMS_Thermal",
    "SN74AUP2G126DCU": "BMS_Thermal", "ISO7041FDBQ": "BMS_Thermal",
    "ISO7021FD": "BMS_Thermal", "SN74LVC2G07DCK": "BMS_Thermal", "SN74AUP2G07DCK": "BMS_Thermal", "BAT54S_AKC": "BMS_Thermal",
    "SN74LVC1G07DCK": "BMS_Thermal", "Conn_01x06_Thermal_MP": "BMS_Thermal",
    "VL822-Q7": "ducktop2",
    "TPS7A0210": "ducktop2",
...
def load_renamed_symbol(name):
    ...
    if name == "USB_C_Receptacle_Passive":
        ...
        if name == "Conn_01x30_FFC_MP":
            block = re.sub(r'(\(property "ki_fp_filters" ")[^"]*(")',
                           r'\1Connector_FFC-FPC:Hirose_FH12-30S-0.5SH*\2', block, count=1)
