...
FOOTPRINT_SOURCES = {
    ...
    "ducktop2:D_SOD-323_JSCJ_1N4148WS": PROJDIR / "ducktop2.pretty" / "D_SOD-323_JSCJ_1N4148WS.kicad_mod",
...
def main(argv=None):
    ...
    for key in key_placements():
        ...
        footprints.append(footprint(
            ...
            key["y"],
            0,
            {"1": key_node, "2": f"KB_COL{key['col']}", "MP": "GND"},
            net_ids,
            schematic_path_by_ref.get(f"SW{ref_n}"),
        ))
        footprints.append(footprint(
            "ducktop2:D_SOD-323_JSCJ_1N4148WS",
            f"D{ref_n}",
            "1N4148WS",
            key["x"] + 8.2,
            key["y"],
