...
| TPS26630 PD1 eFuse acceptance UV rising | 12.35 V | 12.1 to 12.6 V | PASS | VREF*(Rtop+Rmid+Rbot)/(Rmid+Rbot), R800/R801/R802 |
| TPS26630 PD1 eFuse acceptance OV rising | 17.31 V | 17 to 17.6 V | PASS | VREF*(Rtop+Rmid+Rbot)/Rbot, R800/R801/R802 |
| TPS26630 PD1 eFuse current limit | 2.98 A | 2.9 to 3.1 A | PASS | 18/R803(kOhm) |
| TPS26630 PD2 eFuse acceptance UV rising | 12.35 V | 12.1 to 12.6 V | PASS | VREF*(Rtop+Rmid+Rbot)/(Rmid+Rbot), R810/R811/R812 |
| TPS26630 PD2 eFuse acceptance OV rising | 17.31 V | 17 to 17.6 V | PASS | VREF*(Rtop+Rmid+Rbot)/Rbot, R810/R811/R812 |
| TPS26630 PD2 eFuse current limit | 2.98 A | 2.9 to 3.1 A | PASS | 18/R813(kOhm) |
| TPS26630 PD3 eFuse acceptance UV rising | 12.35 V | 12.1 to 12.6 V | PASS | VREF*(Rtop+Rmid+Rbot)/(Rmid+Rbot), R820/R821/R822 |
| TPS26630 PD3 eFuse acceptance OV rising | 17.31 V | 17 to 17.6 V | PASS | VREF*(Rtop+Rmid+Rbot)/Rbot, R820/R821/R822 |
| TPS26630 PD3 eFuse current limit | 2.98 A | 2.9 to 3.1 A | PASS | 18/R823(kOhm) |
| USB-C PD1 nominal pre-attach VBUS capacitance | 4.2 uF | 4.1 to 4.3 uF | PASS | C120+C121+C800+C801+C795+C796 |
| USB-C PD1 worst-case pre-attach VBUS capacitance | 5.54 uF | 0 to 10 uF | PASS | nominal*1.20 + 0.5uF conservative unmodeled allowance; USB Type-C max 10uF |
| USB-C PD2 nominal pre-attach VBUS capacitance | 4.2 uF | 4.1 to 4.3 uF | PASS | C130+C131+C810+C811+C795+C796 |
| USB-C PD2 worst-case pre-attach VBUS capacitance | 5.54 uF | 0 to 10 uF | PASS | nominal*1.20 + 0.5uF conservative unmodeled allowance; USB Type-C max 10uF |
| USB-C PD3 nominal pre-attach VBUS capacitance | 4.2 uF | 4.1 to 4.3 uF | PASS | C140+C141+C820+C821+C795+C796 |
| USB-C PD3 worst-case pre-attach VBUS capacitance | 5.54 uF | 0 to 10 uF | PASS | nominal*1.20 + 0.5uF conservative unmodeled allowance; USB Type-C max 10uF |
| LTC4417 PD1 acceptance UV rising | 13.05 V | 12.8 to 13.3 V | PASS | VREF*(Rtop+Rmid+Rbot)/(Rmid+Rbot), R720/R721/R722 |
| LTC4417 PD1 acceptance OV rising | 17.08 V | 16.7 to 17.5 V | PASS | VREF*(Rtop+Rmid+Rbot)/Rbot, R720/R721/R722 |
| LTC4417 PD2 acceptance UV rising | 13.05 V | 12.8 to 13.3 V | PASS | VREF*(Rtop+Rmid+Rbot)/(Rmid+Rbot), R723/R724/R725 |
| LTC4417 PD2 acceptance OV rising | 17.08 V | 16.7 to 17.5 V | PASS | VREF*(Rtop+Rmid+Rbot)/Rbot, R723/R724/R725 |
| LTC4417 PD3 acceptance UV rising | 13.05 V | 12.8 to 13.3 V | PASS | VREF*(Rtop+Rmid+Rbot)/(Rmid+Rbot), R726/R727/R728 |
| LTC4417 PD3 acceptance OV rising | 17.08 V | 16.7 to 17.5 V | PASS | VREF*(Rtop+Rmid+Rbot)/Rbot, R726/R727/R728 |
...
| 15V PD usable input budget with firmware reserve | 41.28 W | 40 to 42 W | PASS | 15V*(ILIM ceiling-0.25A); actual IINDPM is also capped by CH224A PDO current |
| CH224A I2C maximum series damping | 100 ohm | 0 to 100 ohm | PASS | max(R123/R124/R133/R134/R143/R144) |
| CH224A I2C worst-case divider low contribution | 0.07648 V | 0 to 0.1 V | PASS | 3.6V*Rseries(max*1.01)/(Rpullup(min*0.99)+Rseries(max*1.01)); excludes endpoint VOL and mux RON |
...
| Native USB-C port 1 TPS2553D nominal current limit | 1.319 A | 1.15 to 1.5 A | PASS | 26.38/R70(kOhm) |
| Native USB-C port 1 TPS2553D minimum current limit | 1.168 A | 1.15 to 1.5 A | PASS | 23.36/R70(kOhm) |
| Native USB-C port 1 TPS2553D maximum current limit | 1.492 A | 1.15 to 1.5 A | PASS | 29.84/R70(kOhm) |
| Native USB-C port 2 TPS2553D nominal current limit | 1.319 A | 1.15 to 1.5 A | PASS | 26.38/R90(kOhm) |
| Native USB-C port 2 TPS2553D minimum current limit | 1.168 A | 1.15 to 1.5 A | PASS | 23.36/R90(kOhm) |
| Native USB-C port 2 TPS2553D maximum current limit | 1.492 A | 1.15 to 1.5 A | PASS | 29.84/R90(kOhm) |
...
| LTC4417 ideal-cap selector handoff droop | 0.4863 V | 0 to 0.55 V | PASS | BQ ILIM ceiling*(13us+3.2us)/C737; ESR and adapter loss excluded |
| LTC4418 ideal-cap selector handoff droop | 0.3302 V | 0 to 0.4 V | PASS | BQ ILIM ceiling*(7us+4us)/C746; ESR and source loss excluded |
...
Netlist evidence: `verification/electrical_calculations_netlist.xml`
