...
RADIO_DB_PIN_NETS = {
    ...
    "6":  ("RADIO_DB_5V", "local"),
    "7":  ("GND", "local"),
    "8":  ("RADIO_CODEC_USB_DB_DP", "local"),
    "9":  ("RADIO_CODEC_USB_DB_DN", "local"),
    "10": ("GND", "local"),
...
def build(sheet_symbol_uuid):
    ...
    s.place(
        ...
        pin_nets={
            "1": ("GND", "local"),
            "2": ("RADIO_CODEC_USB_HOST_DP", "hier"),
            "3": ("", "nc"),
            "4": ("RADIO_CODEC_USB_DB_DP", "local"),
            "5": ("GND", "local"),
            "6": ("RADIO_CODEC_USB_DB_DN", "local"),
            "7": ("", "nc"),
            "8": ("RADIO_CODEC_USB_HOST_DN", "hier"),
    ...
    s.place(
        ...
        pin_nets={
            "1": ("RADIO_CODEC_USB_DB_DP", "local"), "6": ("RADIO_CODEC_USB_DB_DP", "local"),
            "3": ("RADIO_CODEC_USB_DB_DN", "local"), "4": ("RADIO_CODEC_USB_DB_DN", "local"),
