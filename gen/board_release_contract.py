...
BOARD_PROJECTS = {
    ...
    'keyboard': {'pcb':'keyboard/12_keyboard_daughterboard.kicad_pcb','schematic':'keyboard/12_keyboard_daughterboard.kicad_sch','copper_layers':2,'routing_state':'RGB keyboard placement, routing pending','routing_complete_required':True},
