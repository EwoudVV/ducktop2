...
def build(sheet_symbol_uuid):
    ...
    s.place("R201", "R", "22R USB DM series", 20, 88.9, footprint=FOOTPRINTS["R"],
            pin_nets={"1": ("EC_USB_ISO_DN", "local"), "2": ("MCU_USB_DN", "hier")})
    s.place("U61", "TS3USB30EDGSR", "TS3USB30EDGSR EC USB host-state isolation", 70, 82.55,
            ...
            pin_nets={
                ...
                "6": ("EC_USB_ISO_DN", "local"), "7": ("EC_DFU_DN", "local"),
                "8": ("EC_HOST_USB_DN", "hier"), "9": ("EC_USB_OE_N", "local"),
                "10": ("MCU_3V3", "hier"),
            }, extra_props={
    ...
    usblc6(s, "U60", "USBLC6-2P6 EC USB ESD", 110, 82.55, "EC_HOST_USB_DP", "EC_HOST_USB_DN", "MCU_3V3")
    s.place("J50", "Conn_01x04", "DNP EC USB probe", 205, 82.55,
            footprint=FOOTPRINTS["Conn_01x04_Header"],
            pin_nets={
                "1": ("GND", "local"),
                "2": ("EC_HOST_USB_DN", "hier"),
    ...
    s.place("J73", "USB_C_Receptacle", "Rear USB-C EC firmware programming port (UFP/DFU)", 310, 216.0,
            ...
            pin_nets={
                ...
                "A7": ("DFU_CONN_DN", "local"), "B7": ("DFU_CONN_DN", "local"),
    ...
    s.place("J58", "Conn_01x04", "Field-soldered trackpad USB2 cable: GND/D-/D+/VBUS", 205, 278.13,
            ...
            pin_nets={
                "1": ("GND", "local"), "2": ("TPAD_CONN_DN", "local"),
