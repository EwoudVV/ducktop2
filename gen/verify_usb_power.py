...
def check(center,left,right):
    ...
    for pin,net in {2:'MCU_3V3',3:'SERVICE_MUX_RESET_N',21:'GND',22:'PD1_I2C_SCL',23:'PD1_I2C_SDA',
                    ...
                    17:'PD1_SOURCE_PG',18:'PD2_SOURCE_PG'}.items():left.expect('U2400',pin,net)
    left.joined(('U2400',3),('FPC101',1),('R2420',1))
    center.joined(('FPC102',68),('U46',4))
    for lp,cp,rp,rcp,net in [(2,67,1,68,'USB_J11_PERMIT'),(3,66,2,67,'USB_J12_PERMIT'),
                              (4,65,3,66,'PD2_SOURCE_PG')]:
    ...
    left.joined(('U2401',3),('U2402',7),('U2411',2))
    ...
    looms=[(center,'J2430',left,'J2431',['VSYS','PD1_VBUS_RAW','USB_PD_SELECTED','AUX_DC_RAW','SYS_3V3','MCU_3V3']+['GND']*6,'43045-1200'),
           (center,'J2432',right,'J2433',['PD2_VBUS_GATED','PD2_VBUS_RAW','SYS_5V','SYS_3V3','PCIE_3V3','MCU_3V3']+['GND']*4,'43045-1000'),
           (left,'J2434',right,'J2435',['USB_PORT_5V']*4+['GND']*4,'43045-0800')]
